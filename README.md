...
* [Использование](#usage)
    ...
    * [Фильтр по авторам, языкам и книгам](#filter)
...
- иконки действий книги с подсказками (скачать, инфо, читать, копировать ссылку)
- переключение цветовой схемы: светлая / тёмная / системная (кнопка в панели инструментов)
- история чтения: отслеживание открытых книг, быстрый возврат через кнопку "Продолжить чтение"
- фиксированная шапка с поиском и пагинацией, прокручиваемый список результатов
- всплывающий попап "О программе" с информацией о версии и ссылкой на новые релизы
...
### Фильтр по авторам, языкам и книгам
...
Аналогично `includeLangs` и `excludeLangs` оставляют и исключают книги на соответствующих языках.
